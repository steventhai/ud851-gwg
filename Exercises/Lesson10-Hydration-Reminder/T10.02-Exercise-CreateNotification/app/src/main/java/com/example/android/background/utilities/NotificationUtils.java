...
public class NotificationUtils {
    private static final int WATER_REMINDER_PENDING_INTENT_ID = 3147;
    private static final String WATER_REMINDER_NOTIFICATION_CHANNEL_ID = "Default Channel";
    private static final int WATER_REMINDER_NOTIFICATION_ID = 3456;
