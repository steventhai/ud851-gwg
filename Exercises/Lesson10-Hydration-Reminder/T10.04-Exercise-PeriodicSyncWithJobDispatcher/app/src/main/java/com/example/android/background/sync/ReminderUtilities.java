...
public class ReminderUtilities {
    ...
    private static final String REMINDER_JOB_TAB = "hydration_reminder_tag";
    ...
    public synchronized static void scheduleChargingReminder(Context context) {
        ...
        builder.setTag(REMINDER_JOB_TAB);
        builder.setConstraints(Constraint.DEVICE_CHARGING);
        builder.setLifetime(Lifetime.FOREVER);
        builder.setTrigger(Trigger.executionWindow(REMINDER_INTERVAL_SECONDS, REMINDER_INTERVAL_SECONDS + SYNC_FLEXTIME_SECONDS));
