...
public class AddTaskActivity extends AppCompatActivity {
    ...
    public void onClickAddTask(View view) {
        ...
        String editText = ((EditText) findViewById(R.id.editTextTaskDescription)).getText().toString();
        ...
        contentValues.put(TaskContract.TaskEntry.COLUMN_DESCRIPTION, editText);
        contentValues.put(TaskContract.TaskEntry.COLUMN_PRIORITY, mPriority);

        // COMPLETED (7) Insert new task data via a ContentResolver
        Uri insert = getContentResolver().insert(TaskContract.TaskEntry.CONTENT_URI, contentValues);
