...
public class MainActivity extends AppCompatActivity {
    ...
    private void loadWeatherData() {
        ...
        new FetchWeatherAsyncTask().execute(url);
    }
    ...
    public class FetchWeatherAsyncTask extends AsyncTask<URL, Void, String[]> {
        ...
        protected String[] doInBackground(URL... urls) {
            ...
            URL url = urls[0];
            String response;
            String[] simpleWeatherStringsFromJson = null;
            try {
                response = NetworkUtils.getResponseFromHttpUrl(url);
                simpleWeatherStringsFromJson = OpenWeatherJsonUtils.getSimpleWeatherStringsFromJson(MainActivity.this, response);
            } catch (Exception e) {
                e.printStackTrace();
            }
